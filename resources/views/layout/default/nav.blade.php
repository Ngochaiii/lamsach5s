        ...
        <div class="kc-wrap-columns header_col">
            ...
            <div id="menu_header" class="kc-elm kc-css-468630 vnt_menu">
                <ul id="nav_header" class="vnt_nav nav_header">
                    ...
                    <li id="menu-item-81" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-81">
                        <a class="menu_link" href="#">Dịch vụ</a>
                        <ul class="sub-menu">
                            @foreach($servicesPosts as $post)
                                <li id="menu-item-{{ $post->id }}" class="menu-item menu-item-type-post_type menu-item-object-page">
                                    <a class="menu_link" href="{{ route('post.detail', $post->slug) }}">{{ $post->title }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
                    <li id="menu-item-172" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-172">
                        ...
                        <ul class="sub-menu">
                            @foreach ($categories as $category)
                                <li id="menu-item-{{ $category->id }}" class="menu-item menu-item-type-taxonomy menu-item-object-category">
                                    <a class="menu_link" href="{{route('category.list',$category->type)}}">{{ $category->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
                    <li id="menu-item-80" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-80">
                        <a class="menu_link" href="{{ route('contact') }}">Liên hệ</a></li>
